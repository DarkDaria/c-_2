...
public:
    X(int ap = 0, int bp = 0, int cp=0, int dp=0): a(ap), b(bp), c(cp), d(dp) //lista inicjalizacyjna
    {
...
class Y: public X //dziedziczenie bez zmiany typu chronienia (co bylo publiczne w X nadal pozostaje publiczne w klasie Y)
        //jakby bylo private to to co bylo public zmienia sie z poziomu klasy Y na private.
{
public:
    int e;
...
int Dziedziczenie_2() {
    {
        std::cout << "X:\n";
        //wywolanie metody z konstruktora
        X x(1, 2, 3, 4);
        x.wypisz();
